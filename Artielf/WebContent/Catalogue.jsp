...
<h3></h3>
					...
					<!-- Row -->
						<div class="row">
							<ul>
							    <li>
									<a href="Catégorie.jsp" class="product" title="Product 1">
										<img src="css/images/product-1.jpg" alt="Product Image 1" />
										<span class="order model">CatéguorieA</span>
										
									</a>
							    </li>
							    <li>
									<a href="Catégorie.jsp" class="product" title="Product 2">
							    ...
							    <li>
									<a href="Catégorie.jsp" class="product" title="Product 3">
							    ...
							    <li>
									<a href="Catégorie.jsp" class="product" title="Product 4">
						...
						<div class="row last-row">
							<ul>
							    <li>
									<a href="Catégorie.jsp" class="product" title="Product 5">
							    ...
							    <li>
									<a href="Categorie.jsp" class="product" title="Product 6">
							    ...
							    <li>
									<a href="Categorie.jsp" class="product" title="Product 7">
							    ...
							    <li>
									<a href="Categorie.jsp" class="product" title="Product 8">
